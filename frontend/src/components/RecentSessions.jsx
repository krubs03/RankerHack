...
function RecentSessions({ sessions, isLoading }) {
  return (
    <div className="card bg-base-100 border-2 border-accent/40 hover:border-accent/60 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {isLoading ? (
              ...
              >
                ...
                <div className="card-body p-5">
                  <div className="flex items-start gap-3 mb-4">
                    <div
                      className={`size-12 rounded-xl flex items-center justify-center ${session.status === "active"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <span
                        className={`badge badge-sm ${getDifficultyClass(session.difficulty)}`}
                      >
            ...
            <div className="col-span-full text-center py-16">
              <div className="size-20 mx-auto mb-4 bg-linear-to-br from-accent/20 to-secondary/20 rounded-3xl flex items-center justify-center">
                <Trophy className="size-10 text-accent opacity-50" />
              </div>
